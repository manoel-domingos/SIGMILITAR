                    ...
                    <div key={o.id} className="py-4 first:pt-0 last:pb-0 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
                        ...
                        <Link
                          ...
                          className="p-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700/80 rounded-lg text-slate-500 hover:text-slate-850 dark:text-slate-400 dark:hover:text-white transition"
