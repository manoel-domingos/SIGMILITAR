                  ...
                  <div key={o.id} className="p-4 space-y-3">
                    ...
                    {o.procedimento_executado && (
                      <div>
                        ...
                        <p className="text-xs font-semibold text-slate-650 dark:text-slate-350">{o.procedimento_executado}</p>
                      </div>
                    )}
                ...
                filteredOcorrencias.map(o => {
                  ...
                  return (
                    <tr key={o.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/10 transition-colors">
                      ...
                      <td className="py-4 px-4 font-extrabold text-slate-800 dark:text-slate-255 max-w-[200px] truncate" title={studentsList}>
                        {studentsList}
                      </td>
