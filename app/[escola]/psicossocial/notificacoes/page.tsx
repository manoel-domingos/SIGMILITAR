    ...
    <AppShell>
      <div className="p-4 sm:p-8 space-y-6 min-h-screen pb-24 animate-in fade-in duration-300">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-4">
          <div>
            <h1 className="text-xl sm:text-2xl font-extrabold text-slate-850 dark:text-white flex items-center gap-2">
                ...
                <div key={f.id} className="p-4 space-y-2">
                  ...
                  <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-50 dark:border-slate-850">
                    <Link
                      ...
                      className="px-3 py-1.5 bg-slate-105 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700/80 rounded-lg text-[10px] font-bold text-slate-600 dark:text-slate-350 transition flex items-center gap-1"
                    >
                      Ver / Imprimir
                    </Link>
                    <button
              ...
              {fichas.length === 0 ? (
                ...
                fichas.map(f => (
                  <tr key={f.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/10 transition-colors">
                    ...
                    <td className="py-4 px-4 font-semibold text-slate-650 dark:text-slate-350 max-w-[200px] truncate" title={getViolacaoLabels(f.tipo_violacao)}>
