            ...
            <div className="space-y-3">
              {violenciasStats.length === 0 ? (
                ...
                violenciasStats.map((item, idx) => (
                  <div key={idx} className="flex justify-between items-center text-xs font-semibold text-slate-655 dark:text-slate-355">
              ...
              {statusStats.total === 0 ? (
                ...
                <div className="space-y-3.5">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="h-2 bg-slate-100 dark:bg-slate-855 rounded-full overflow-hidden">
