# MASTER.md — Sub-agente: Relatorios
...
**Resumo:** Relatórios, DRE e análises
...
|-----------|-------|---------------|
| Fechamentos pendentes | Verificar | 2026-06-08 |
| Relatórios gerados (30d) | Consultar logs | 2026-06-08 |
...
Para análise superficial: este arquivo contém o resumo mais recente do domínio **Relatorios**.
Para análise profunda: acione o sub-agente lendo `agents/relatorios/CLAUDE.md` e os arquivos em `agents/relatorios/data/`.
